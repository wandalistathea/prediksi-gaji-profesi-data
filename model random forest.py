...
plt.savefig("gambar/11. Distplot Gaji (300 Data).png")
...
plt.savefig("gambar/12. Distplot Gaji Setelah Transformasi (300 Data).png")
...
# random_search ini itu sebagai modelnya
# Simpan model
